...
## 对照模块
- 设计：`data_persistence/config/`、`data_persistence/embedding/`
- 代码：
  - `backend/app/data_layer/data_persistence/config/settings.py`
  - `backend/app/data_layer/data_persistence/embedding/embedding_client.py`
