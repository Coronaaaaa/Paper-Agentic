...
## 对照模块
- 设计：`data_persistence/chroma_store/`
- 代码：
  - `backend/app/data_layer/data_persistence/chroma_store/vector_index.py`
  - `backend/app/data_layer/data_persistence/chroma_store/keyword_index.py`
  - `backend/app/data_layer/data_persistence/chroma_store/soft_delete.py`
