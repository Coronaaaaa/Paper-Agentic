...
## 对照模块
- 设计：`data_persistence/file_management/`、`data_persistence/monitor/`
- 代码：
  - `backend/app/data_layer/data_persistence/file_management/directory_manager.py`
  - `backend/app/data_layer/data_persistence/monitor/storage_monitor.py`
