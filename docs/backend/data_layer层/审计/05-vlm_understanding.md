...
## 对照模块
- 设计：`PDF_preprocessor_data/vlm_understanding/`
- 代码：
  - `backend/app/data_layer/PDF_preprocessor_data/vlm_understanding/vlm_processor.py`
  - `backend/app/data_layer/PDF_preprocessor_data/vlm_understanding/__init__.py`
