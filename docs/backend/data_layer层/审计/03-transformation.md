...
## 对照模块
- 设计：`PDF_preprocessor_data/transformation/`
- 代码：
  - `backend/app/data_layer/PDF_preprocessor_data/transformation/pdf_converter.py`
  - `backend/app/data_layer/PDF_preprocessor_data/transformation/markitdown_adapter.py`
