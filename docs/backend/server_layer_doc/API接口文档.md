...
```
event: metadata
data: {"request_id": "abc123", "session_id": "xxx", "used_inputs": {"prompt": 1.0, "selection": 0.0, "written_context": 0.0}, "context_tokens": 150, "remaining_tokens": 31850, "remaining_ratio": 0.9953, "retrieval_planned": true, "degraded_flags": [], "cache_mode": "memory"}
```
